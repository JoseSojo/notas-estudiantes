...
export default function ExportLapso3 () {
    ...
    return (
        <div>
            <button
                onClick={() => generatePDF(tableRef, {filename: 'Notas Tercer Lapso.pdf', page:{margin:Margin.MEDIUM, orientation:"p"}})}
            ...
            </button>
            {
                ...
                :   <div ref={tableRef} className='w-full grid place-items-center gap-5 pt-5 p-10'>
                        <h2 className='text-center text-5xl font-extralight text-gray-800'>NOTAS TERCER LAPSO</h2>
                            ...
                            <tbody>
                                {
                                    students && students.map((st)=>(
                                        <tr className='grid grid-cols-6' key={st.id}>
                                            ...
                                            <td className='border text-center py-3 text-md text-gray-700 col-span-1'>{ SumNot({notas:st.notas_reference.l3}) }</td>
                                            <td className='border text-center py-3 text-md text-gray-700 col-span-2'>{st.notas_reference.coment3}</td>
                                        </tr>
                                    ))
                                }
                            </tbody>
